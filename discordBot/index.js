...
//     let welcomeRole = guildMember.guild.roles.cache.find(role => role.name === 'player');
...
// client.on("messageReactionAdd", (emojiU) => {
//     console.log(emojiU.users);
// });
...
//             reaction.message.guild.members.cache.get(user.id).roles.add(playerRole);
//         }else{
//             return;
//         }
//     }
...
//     if (reaction.message.channel.id == channel) {
//         if (reaction.emoji.name == playerRoleEmoji) {
//             reaction.message.guild.members.cache.get(user.id).roles.remove(playerRole);
//         }else{
//             return;
//         }
//     }
